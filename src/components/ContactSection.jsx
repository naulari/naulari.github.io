...
const Instagram = () => (
    <svg role="img" xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 24 24">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
                    ...
                    <div className="bg-card p-8 rounded-lg shadow-xs" 
                        ...
                        <form className="space-y-6">
                            <div>
                                <label htmlFor="name"
                                    className="block text-sm font-medium b-2"> Your Name</label>
                                <input id="name" 
                                    required 
                                    type="text" 
                            ...
                            <div>
                                <label htmlFor="email"
                                    className="block text-sm font-medium b-2"> Your Email</label>
                                <input id="email" 
                                    required 
                                    type="email" 
                                    className="w-full px-4 py-3 rounded-md border border-input bg-background focus:outline-hidden focus:ring-2 focus:ring-primary"
                            ...
                            <div>
                                <label htmlFor="message"
                                    className="block text-sm font-medium b-2"> Your Message</label>
                                <textarea id="message" 
                                    required 
