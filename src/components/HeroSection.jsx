...
export const HeroSection = () => {
    ...
    return (
        <section id="hero" 
            className="relative min-h-dvh flex flex-col items-center justify-center px-4 py-24 overflow-hidden">

            <div className="container max-w-5xl mx-auto text-center z-10">
                <div className="space-y-6"> 
                         
                    <h1 className="text-2xl min-[390px]:text-3xl min-[460px]:text-4xl sm:text-5xl md:text-6xl font-bold tracking-tight ">
        ...
        <div className="absolute bottom-1 md:bottom-8 left-1/2 -translate-x-1/2 flex flex-col items-center animate-bounce ">
